...
?>
    ...
    <body  style="background-image: url('../../images/background-image.png');">
        <div class="cont">
            <form method="post" action="../../controller/customerlogincontroller.php?status=change_froget_password"  id="customer_loginform">
              <div class="form">
            ...
            <div class="sub-cont">
                <div class="img" style="background-image: url('../../images/customer-login.jpg'); width: 600px"></div>
            </div>
        </div>
