    ...
    <body  style="background-image: url('../../../images/background-image.png');">
        ...
        <form id="editUser" enctype="multipart/form-data" method="post" action="../../../controller/usercontroller.php?status=edit_self">
              <div class="cont">
                  ...
                  <input type="hidden" value="../view/user/project_manager/pro-manager-profile-update.php" id="redirect" name="redirect">
               <div class="row">
                    <div class="col-md-4">
                    <h3>Update</h3>
             ...
             <div class="clearfix">
                 <button onclick="document.location='pro-manager-dashboard.php'" type="button" class="btn btn-danger" style="width: 440px">Cancel</button>&nbsp;&nbsp;&nbsp;
