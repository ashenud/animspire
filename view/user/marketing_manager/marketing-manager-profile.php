    ...
    <body  style="background-image: url('../../../images/background-image.png');">
        <div class="cont">
            ...
            <div class="profile" style="color: #777378">
                ...
                <hr>
                <div class="button">
                    <a href="marketing-manager-profile-update.php?user_id=<?php echo base64_encode($userRow["user_id"]); ?>" type="button" class="btn btn-success" style="width: 220px; text-align: center">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" value="../view/user/marketing_manager/marketing-manager-profile.php" id="redirect" name="redirect">
                            </div>
                        </div>
