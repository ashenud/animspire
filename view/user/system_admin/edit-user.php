        ...
        <form id="editUser" enctype="multipart/form-data" method="post" action="../../controller/usercontroller.php?status=edit_user">
             ...
             <hr>
                ...
                <div class="form-group" style="margin-top: 8px; margin-left: 15px; width: 47%"">
                  ...
                  <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" value="<?php echo $userRow["user_email"]; ?>" readonly="readonly" />
                </div>
             ...
             <div class="clearfix">
                 <button onclick="document.location='user-management.php'" type="button" class="btn btn-danger" style="width: 440px">Cancel</button>&nbsp;&nbsp;&nbsp;
