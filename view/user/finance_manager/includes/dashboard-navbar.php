...
<div class="sidebar">
    <a href="./finance-manager-dashboard.php"><img src="../../../images/Animspire-Logo.png" id="logo"></a>
...
<div class="top-navbar">
    <a href="./finance-manager-profile.php?user_id=<?php echo $userId; ?>"><img
    ...
    <a href="./finance-manager-dashboard.php" name="home" class="btn btn-primary home-btn">Home</a>
    <div class="dropdown">
            ...
            <?php
                if ($count > 0) {
                    while($dataRow = $messages->fetch_assoc()) {
                        ?>
                        <a class="dropdown-item" href="./finance-manager-chat.php?user_id=<?php echo base64_encode($dataRow['sender_id']);?>&msg_ids=<?php echo base64_encode($dataRow['msg_ids']);?>">From : <?php echo $dataRow['sender_name'];?></a>
                        <?php
                    }
                }
                else {
