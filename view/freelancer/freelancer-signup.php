...
<html>
    ...
    <body  style="background-image: url('../../images/background-image.png');">
        ...
        <form id="addFreelancer" enctype="multipart/form-data" method="post" action="../../controller/freelancercontroller.php?status=add_freelancer">
              <div class="cont">
               <div class="row">
                    <div class="col-md-4">
                    <h3>Sign Up</h3>
   ...
   ?>
    <script src="../../js/freelancer_validation.js"></script>
